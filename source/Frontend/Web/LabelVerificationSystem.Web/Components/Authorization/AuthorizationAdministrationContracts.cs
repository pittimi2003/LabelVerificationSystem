...
public sealed record UpdateRoleAuthorizationMatrixRequestDto(IReadOnlyList<UpdateRoleModuleAuthorizationDto> Modules);
...
public sealed record UpdateRoleModuleActionAuthorizationDto(Guid ActionId, bool Authorized);
